...
<div class="container" id="mainContent">
    ...
    <div class="list-group">
        ...
        <?php if (havePrivilege("SUPERUSER")) { ?>
            <a href="./problem_changeid.php" class="list-group-item">
                <h4 class="list-group-item-heading"><i class="fa fa-exchange"></i> Problen Change ID</h4>
                <p class="list-group-item-text">改变题目序号</p>
            </a>
        <?php } ?>
