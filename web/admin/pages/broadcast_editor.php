...
<div class="container" id="mainContent">
    <div class="page-header">
        <h1><?php echo LA_CAST_MAN; ?>
            <small>Announcement Editor</small>
        </h1>
    </div>
    <p class="lead">
    ...
    <form method="POST" class="form-horizontal">
        ...
        <textarea class="summernote" placeholder="Enter Announcement Content"
                  name="broadcast_content"><?php echo $OJ_ANNOUNCEMENT; ?></textarea>
        <br/>
