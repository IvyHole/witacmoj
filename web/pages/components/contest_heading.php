<?php 
	...
	if (time()>strtotime($contestItem['end_time'])) $contestAuthResult = true;
		...
		if (havePrivilege("CONTEST_EDITOR") || isset($_SESSION["m{$cid}"]) || isset($_SESSION["c{$cid}"])||!$contestItem['private']) $contestAuthResult = true;
	}
...
<div id="contestHeading" class="text-center">
	...
	<div class="btn-group" role="group">
		...
		<!--<a type="button" href="contest_listtopic.php?cid=<?php echo $cid;?>" class="btn btn-default"><?php echo L_CLARIFICATION; ?></a>-->
