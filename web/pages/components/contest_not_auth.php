<div class="jumbotron">
	...
	<?php if (!isset($_SESSION['user_id']) ) { ?>
		...
		<p>
		<a class="btn btn-primary btn-lg" href="./login.php" role="button"><?php echo L_LOGIN;?></a> <?php echo L_OR;?>
		<a class="btn btn-primary btn-lg" href="./register.php" role="button"><?php echo L_REGISTER;?></a>
		</p>
	<?php } ?>
	</div>
</div>