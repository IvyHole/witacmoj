				...
				<div class="col-lg-12">
					...
					<div class="row">
						<div class="col-lg-3 col-sm-3">
							...
							<a href="status.php?uid=<?php echo $user_id; ?>&judgeresult=4">
						...
						<div class="col-lg-6 col-sm-6">
							...
							<div class="panel-heading">
								<div class="row">
								<div class="col-xs-3">
                                    <img src="https://www.gravatar.com/avatar/<?php echo md5($user_email)?>?d=identicon&s=128">
<!--									<i class="fa fa-user fa-5x"></i>-->
					...
					<div class="row">
						<div class="col-sm-6">
							<ul class="list-group">
								<li class="list-group-item"><?php echo L_SOLVED;?>: <a href="status.php?uid=<?php echo $user_id; ?>&judgeresult=4"><?php echo $user_solved;?> Solved</a></li>
