			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-3 col-xs-6">
					...
					<div class="input-group">
						<input type="text" class="form-control" name="pid" placeholder="Input item number">
				...
				<form method="get">
					<div class="input-group">
						<input type="text" name="wd" id="keyword" class="form-control" placeholder="Enter Title Keyword">
						<span class="input-group-btn">
